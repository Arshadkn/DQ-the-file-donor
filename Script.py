class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {}, Hᴇʏ Arshad ɪ'ᴍ ᴅᴏʀᴀV3 ᴀɴ Aᴡᴇsᴏᴍᴇ Aᴜᴛᴏ + Mᴀɴᴜᴀʟ Fɪʟᴛᴇʀ + Fɪʟᴇ Sʜᴀʀᴇ Bᴏᴛ.</b>\n\n\n<code>Sᴏʀʀʏ ɪ ᴏɴʟʏ ᴡᴏʀᴋ ᴏɴ @Dcenimaunverse Gʀᴏᴜᴘ. Nᴏ ᴏᴛʜᴇʀ ᴄᴏᴍᴍᴀɴᴅ ᴡɪʟʟ ᴡᴏʀᴋ ᴏɴ ᴛʜɪs ʙᴏᴛᴇxᴄᴇᴘᴛ sᴛᴀʀᴛ. ᴅᴏɴ’ᴛ ᴡᴀsᴛᴇ ʏᴏᴜʀ ᴛɪᴍᴇ</code>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>✯ Mʏ Nᴀᴍᴇ: {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/Arshadkz'>Aʀsʜᴀᴅ Kᴏᴛᴛᴀʏɪ</a>
✯ Lɪʙʀᴀʀʏ: <a href='https://docs.pyrogram.org/'>Pʏʀᴏɢʀᴀᴍ</a>
✯ Lᴀɴɢᴜᴀɢᴇ: <a href='https://www.python.org/download/releases/3.0/'>Pʏᴛʜᴏɴ 3</a>
✯ DᴀᴛᴀBᴀsᴇ: <a href='https://www.mongodb.com/'>MᴏɴɢᴏDB</a>
✯ Bᴏᴛ Sᴇʀᴠᴇʀ: <a href='https://app.Railway.com/'>Rᴀɪʟᴡᴀʏ</a>
✯ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: v2.</b>"""
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """⚠️ {}, മറ്റുള്ളവർ റിക്വസ്റ്റ് ചെയ്ത മുവിയിൽ കുത്തി നോക്കാതെ. Broo വേണ്ടത് Broo റിക്വസ്റ്റ് ചെയ്യുക🤒.

❕ Broo, Search Your Own File.Don't Click Others Request File's ❕ """
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : AʀsʜᴀᴅKɴᴢ
• ᴜꜱᴇʀɴᴀᴍᴇ : @Arshadkz
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/Arskottu'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
<b>
╭─────── • ◆ • ───────╮
🔅 Dᴀʀᴋ Mᴏᴅᴇ :  <a href="https://t.me/DCENIMAS">Tᴏᴜᴄʜ</a>
╰─────── • ◆ • ───────╯

=========== • ✠ • ===========
▫️ ᴄʜᴀɴɴᴇʟ : @DCENIMAS
▫️ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : @DCENIMA_HD
=========== • ✠ • ===========</b>"""
