class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},
 Hᴇʏ Arshad ɪ'ᴍ ᴅᴏʀᴀV3 ᴀɴ Aᴡᴇsᴏᴍᴇ Aᴜᴛᴏ + Mᴀɴᴜᴀʟ Fɪʟᴛᴇʀ + Fɪʟᴇ Sʜᴀʀᴇ Bᴏᴛ.</b>\n\n\n<code>Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ ᴏʀ ʀᴇᴀᴅ ᴍᴏʀᴇ ғʀᴏᴍ ᴛʜᴇ ᴍᴇɴᴜ ʙᴇʟᴏᴡ</code>"""
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """<b>⚠️ {}, മറ്റുള്ളവർ റിക്വസ്റ്റ് ചെയ്ത മുവിയിൽ കുത്തി നോക്കാതെ. Broo വേണ്ടത് Broo റിക്വസ്റ്റ് ചെയ്യുക🤒.</b><b>
❕ Broo, Search Your Own File.Don't Click Others Request File's ❕ </b>"""
